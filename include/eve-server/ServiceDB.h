...
public:
    ...
    double GetCorpBalance(uint32 corpID, uint32 corpAccountKey);
    bool AddBalanceToCorp(uint32 corpID, double amount, uint32 corpAccountKey);

	// character related
	bool SetCorpAccountKey( uint32 characterID, uint32 corpAccountKey );
